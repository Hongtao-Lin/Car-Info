...
load_file = "model/svm_model_segment_11_cleaner_chi2_15000.pkl"
...
# get top-k words from each class via SVM feature.
...
# test senteces from test_s, get detailed results.
def sentence():
	for data in test_s:
		predict_sentence_detail(clf, data)

# test passages, output
def passage():
	for data in test_p:
		predict_passage_by_correlation(clf, data)

# Predict the pasaage by whether to consider the correlation btw splited sentences.
...
# The following are ways to evaluate how is the passage performance.
...
# visulize passage with highlighted class using color. 
# Not currently used
